...
4. 正式環境機密逐一 `wrangler secret put <NAME>`：`INSTAGRAM_APP_SECRET`、`WEBHOOK_VERIFY_TOKEN`、`INSTAGRAM_ACCOUNT_ACCESS_TOKEN`、`ADMIN_SESSION_SECRET`。設定後約 30 秒才生效，勿立即以舊回應誤判。
